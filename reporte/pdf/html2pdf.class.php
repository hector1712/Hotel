...
set_time_limit(500);
>>>>>>> ac9f2711b2adb34dcc526f2354ef18483532ac24
 ...
 $tmp = array(); $tmp[]=$pt[4]; $tmp[]=$pt[5]; $tmp[]=$pt[6]; $tmp[]=$pt[7]; $tmp[]=$pt[8]; $tmp[]=$pt[9];
                ...
                for ($i=0; $l-($px+$py)*($i-0.5)>0; $i++) {
                    if (($i%2)==$mode) {
                        ...
                        $ly2 = $py*($j+1); if ($ly2>$l)  $ly2 = $l;$tmp = array();
